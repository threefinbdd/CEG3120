...
$servers->setValue('server','name','BDD CEG3120 LDAP');
...
$servers->setValue('server','base',array('dc=bdd-ldap-dn,dc=com'));
...
$servers->setValue('login','bind_id','cn=admin,dc=bdd-ldap-dn,dc=com');
